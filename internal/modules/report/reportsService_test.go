...
func TestBirthdayReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		out, err := service.BirthdayReport(context.Background())
		assert.NotNil(t, out)
		assert.Nil(t, err)
	})
...
func TestMarriageReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		querySpec := wrapper.QuerySpecification(nil)
		memberService.EXPECT().SearchMembers(gomock.Any(), gomock.AssignableToTypeOf(querySpec)).Return(BuildMembers(1), nil)
		out, err := service.MarriageReport(context.Background())
		assert.NotNil(t, out)
		assert.Nil(t, err)
	})
	t.Run("Fail - search members", func(t *testing.T) {
...
func TestGenerateMemberReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		out, err := service.MemberReport(context.Background())
		assert.NotNil(t, out)
		assert.Nil(t, err)
	})
	t.Run("Fail", func(t *testing.T) {
		...
		_, err := service.MemberReport(context.Background())
		assert.NotNil(t, err)
	})
}
...
func TestGenerateClassificationReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		out, err := service.ClassificationReport(context.Background(), classification.ADULT)
		assert.NotNil(t, out)
		assert.Nil(t, err)
	})
	t.Run("Fail", func(t *testing.T) {
		...
		_, err := service.ClassificationReport(context.Background(), classification.ADULT)
		assert.NotNil(t, err)
	})
...
func TestGenerateLegalReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		out, err := service.LegalReport(context.Background())
		assert.NotNil(t, out)
		assert.Nil(t, err)
	})
	t.Run("Fail", func(t *testing.T) {
		...
		spec := member.Specification(nil)
		memberService.EXPECT().SearchMembers(gomock.Any(), gomock.AssignableToTypeOf(querySpec), gomock.AssignableToTypeOf(spec)).Return(nil, genericError)
		_, err := service.LegalReport(context.Background())
		assert.NotNil(t, err)
	})
