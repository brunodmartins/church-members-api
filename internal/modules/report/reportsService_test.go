...
func TestBirthdayReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		memberService.EXPECT().SearchMembers(gomock.AssignableToTypeOf(spec)).Return(BuildMembers(1), nil)
	...
	t.Run("Fail - search members", func(t *testing.T) {
		spec := member.Specification(nil)
		memberService.EXPECT().SearchMembers(gomock.AssignableToTypeOf(spec)).Return(nil, genericError)
		out, err := service.BirthdayReport()
		assert.Nil(t, out)
		assert.NotNil(t, err)
	})
...
func TestGenerateMemberReport(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		memberService.EXPECT().SearchMembers(gomock.AssignableToTypeOf(member.Specification(nil))).Return(members, nil)
	...
	t.Run("Fail", func(t *testing.T) {
		memberService.EXPECT().SearchMembers(gomock.AssignableToTypeOf(member.Specification(nil))).Return(nil, genericError)
...
func TestGenerateLegalReport(t *testing.T) {
	...
	service := report.NewReportService(memberService, fileBuilder)
	t.Run("Success", func(t *testing.T) {
		memberService.EXPECT().SearchMembers(gomock.AssignableToTypeOf(member.Specification(nil))).Return(BuildMembers(0), nil)
